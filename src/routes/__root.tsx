...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GovVisit — Government Visitor Management" },
      {
        name: "description",
        content:
          "GovVisit manages visitor registration, check-in, checkout and reporting for government facilities.",
      },
      { name: "author", content: "Federal Public Services Administration" },
